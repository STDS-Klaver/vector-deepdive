...
ggplot(data = cantons_result) +
  ...
  scale_fill_viridis_c(
    name = "Forest Cover (%)",
    option = "viridis",
    breaks = breaks_vec, # Set specific tick marks
    guide = guide_colorbar(
      barheight = unit(4, "cm"), 
      barwidth = unit(0.5, "cm"), 
      frame.colour = "black",     # Add frame for clarity
      ticks.colour = "black"
    )
  ) +
  theme_minimal() +
...
ggplot() +
  # Background destination grid
  geom_sf(data = grid_dest, fill = "lightgrey", color = "white") + 
  # Origin square in the center
  geom_sf(data = grid_orig, fill = "lightblue", color = "white") +
  # Sampled points in the valid Queen's movement squares
  geom_sf(data = grid_queen, color = "red", size = 0.5) + 
  theme_void() +
...
st_queen <- \(x, y) st_relate(x, y, pattern = "F***0****")
